...
public class OreDict {
		...
		public static void addCopper() {
			...
			OreDictionary.registerOre("dustCopper", new ItemStack(ModItems.dustCopper));
		...
		public static void addSilver() {
			...
			OreDictionary.registerOre("ingotSilver", new ItemStack(ModItems.ingotSilver));
			OreDictionary.registerOre("dustSilver", new ItemStack(ModItems.dustSilver));
			OreDictionary.registerOre("blockSilver", new ItemStack(ModBlocks.blockSilver));
		}	
		...
		public static void addRawRubber() {
			OreDictionary.registerOre("itemRawRubber", new ItemStack(ModItems.rawRubber));
		}	
		
	
		public static void addRubber() {
			OreDictionary.registerOre("itemRubber", new ItemStack(ModItems.ingotRubber));
			OreDictionary.registerOre("ingotRubber", new ItemStack(ModItems.ingotRubber));
		}
	
		public static void addMortarAndPestle() {
			OreDictionary.registerOre("craftingMortarAndPestle", new ItemStack(ModItems.mortarAndPestle, 1, 0));
			OreDictionary.registerOre("craftingMortarAndPestle", new ItemStack(ModItems.mortarAndPestle, 1, 1));
			OreDictionary.registerOre("craftingMortarAndPestle", new ItemStack(ModItems.mortarAndPestle, 1, 2));
			OreDictionary.registerOre("craftingMortarAndPestle", new ItemStack(ModItems.mortarAndPestle, 1, 3));
