...
public class ModExistence {
	...
	public static void Compat() {
		...
		if (Loader.isModLoaded("ThermalExpansion")) {
			...
			leadMods = leadMods++;
			System.out
					.println("[Unified Items] Thermal Expansion Integration Loaded");
		}

		else {
			System.out
					.println("[Unified Items] Thermal Expansion Integration Not Loaded");
		}
		...
		if (Loader.isModLoaded("EnderIO")) {
			...
			System.out
					.println("[Unified Items] EnderIO Integration Not Loaded");
		}
		...
		if (Loader.isModLoaded("Factorization")) {
			...
			silverMods = silverMods++;
			System.out
					.println("[Unified Items] Factorization Integration Loaded");
		}

		else {
			System.out
					.println("[Unified Items] Factorization Integration Not Loaded");
		}
		...
		if (Loader.isModLoaded("Forestry")) {
			...
			System.out
					.println("[Unified Items] Forestry Integration Not Loaded");
		}
		...
		if (Loader.isModLoaded("TConstruct")) {
			...
			copperMods = copperMods++;
			System.out
					.println("[Unified Items] Tinker's Construct Integration Loaded");
		}

		else {
			System.out
					.println("[Unified Items] Tinker's Construct Integration Not Loaded");
		}
