...
public class Shapeless {
	...
	public static void addCrafting() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModBlocks.blockSilver),
				new ItemStack(ModItems.ingotSilver), new ItemStack(
						ModItems.ingotSilver), new ItemStack(
						ModItems.ingotSilver), new ItemStack(
						ModItems.ingotSilver), new ItemStack(
						ModItems.ingotSilver), new ItemStack(
						ModItems.ingotSilver), new ItemStack(
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModBlocks.blockLead),
				new ItemStack(ModItems.ingotLead), new ItemStack(
						ModItems.ingotLead), new ItemStack(ModItems.ingotLead),
				new ItemStack(ModItems.ingotLead), new ItemStack(
						ModItems.ingotLead), new ItemStack(ModItems.ingotLead),
				new ItemStack(ModItems.ingotLead), new ItemStack(
						ModItems.ingotLead), new ItemStack(ModItems.ingotLead));
		...
		GameRegistry.addShapelessRecipe(
				new ItemStack(ModItems.mortarAndPestle), new ItemStack(
						Items.bowl), new ItemStack(Blocks.cobblestone));

		// Adds a recipe for flint
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				Items.flint, 1), new Object[] { "blockGravel",
				"craftingMortarAndPestle" }));

		// Adds The Recipes for Ores to Dusts
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				ModItems.dustIron, 2), new Object[] { "oreIron",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				ModItems.dustGold, 2), new Object[] { "oreGold",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				ModItems.dustCopper, 2), new Object[] { "oreCopper",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				ModItems.dustTin, 2), new Object[] { "oreTin",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				ModItems.dustSilver, 2), new Object[] { "oreSilver",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				ModItems.dustLead, 2), new Object[] { "oreLead",
				"craftingMortarAndPestle" }));

		// Miscellaneous Recipes
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				Blocks.torch, 2), new Object[] { "stickWood",
				"craftingFlintAndSteel" }));
	}
}