...
/*
		...
		GameRegistry.addShapelessRecipe(new ItemStack(UIItems.dustBronze, 4), new ItemStack(UIItems.dustCopper), new ItemStack(UIItems.dustCopper), new ItemStack(UIItems.dustCopper), new ItemStack(UIItems.dustTin));
		...
		GameRegistry.addShapelessRecipe(
				new ItemStack(UIItems.mortarAndPestle), new ItemStack(
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				UIItems.dustIron, 2), new Object[] { "oreIron",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				UIItems.dustGold, 2), new Object[] { "oreGold",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				UIItems.dustCopper, 2), new Object[] { "oreCopper",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				UIItems.dustTin, 2), new Object[] { "oreTin",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				UIItems.dustSilver, 2), new Object[] { "oreSilver",
				"craftingMortarAndPestle" }));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(
				UIItems.dustLead, 2), new Object[] { "oreLead",
				"craftingMortarAndPestle" }));
