...
public class Smelting {
	...
	public static void init() {
		...
		GameRegistry.addSmelting(UIItems.dusts.get(MaterialRegistry.IRON), new ItemStack(Items.IRON_INGOT), 0.5f);
		GameRegistry.addSmelting(UIItems.dusts.get(MaterialRegistry.GOLD), new ItemStack(Items.GOLD_INGOT), 0.5f);
