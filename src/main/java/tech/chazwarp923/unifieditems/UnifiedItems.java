...
@Mod(modid = Reference.MOD_ID, name = Reference.MOD_NAME, version = Reference.VERSION, updateJSON = "http://chazwarp923.tech/UnifiedItems.json", acceptedMinecraftVersions = "[1.12.0]", guiFactory = "tech.chazwarp923.unifieditems.config.ConfigGuiFactory")
